...
public class SAMController {
    ...
    // JSON Body e.g.: { "colours": ["red", "black"] , "sizes": "["S", "M", "L", "XL"] }
    // JSON BODY MUST BE IN THE CORRECT FORMAT: List<String> colours, List<String> sizes
    ...
    public ResponseEntity<Object> createProduct(@PathVariable String modelCode, @RequestBody Map<String, List<String>> body) {
        try {
    ...
    public ResponseEntity<Object> getModelsByFieldValue(@PathVariable String fieldName, @PathVariable String fieldValue) {
        try {
    ...
    public ResponseEntity<Object> getProductsByFieldValue(@PathVariable String fieldValue, @PathVariable String fieldName) {
        try {
    ...
    public ResponseEntity<Object> sellProductItem(@PathVariable String rfid, @RequestBody(required = false) Object body) {
        try {
    ...
    public ResponseEntity<Object> returnProductItem(@PathVariable String rfid, @RequestBody(required = false) Object body) {
        try {
