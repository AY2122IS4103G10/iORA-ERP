...
export function Login() {
  ...
  const handleReset = async (e) => {
    ...
    try {
      ...
      addToast(`Password was successfuly reset. ${data} Check your e-mail for temporary password`, {
        appearance: "success",
        autoDismiss: true,
      });
      ...
      <div className=" min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-white border py-8 px-4 shadow sm:rounded-lg sm:px-10">
            <form className="space-y-6" onSubmit={resetPassword ? handleReset : handleLogin}>
              <div>
