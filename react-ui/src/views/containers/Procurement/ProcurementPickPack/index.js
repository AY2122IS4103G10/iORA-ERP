      ...
      <div className="md:flex md:items-center md:justify-between">
        ...
        {data
          ...
          manufacturing.id === currSiteId && (
            <button
              type="button"
              className="sm:mt-2 inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-cyan-600 hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-cyan-500"
              onClick={() => {
                setShowConfirm(true);
              }}
            >
